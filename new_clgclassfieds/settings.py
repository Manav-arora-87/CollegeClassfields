"""
Django settings for new_clgclassfieds project.
...
SECRET_KEY = 'django-insecure-c8t)=h*@@b5^5bkhy_ss0(eze8=&%cwwz(3+-_bc40jym4fm29'
...
ROOT_URLCONF = 'new_clgclassfieds.urls'
...
WSGI_APPLICATION = 'new_clgclassfieds.wsgi.application'
